        ...
        <body>
                    ...
                    <div class="container-fluid scroll-area">
                        <div class="center-box">
                            ...
                            <form action="/invoice/insertShopping" method="get">
                                <div class="mb-3">
                                    <label for="disGrade" class="form-label">지역 선택</label> <select name="disGrade"
                                        id="disGrade" class="form-select" onchange="updateDisplay()">
                                ...
                                <div class="mb-3">
                                    <label for="weight" class="form-label">무게 선택</label> <select name="weight"
                                        id="weight" class="form-select" onchange="updateDisplay()">
                                ...
                                <div class="mb-3">
                                    <label for="adPrice" class="form-label">추가 금액</label> <input type="number"
                                        id="adPrice" name="adPrice" class="form-control" min="0" max="1000000"
                                        step="1000">
                                </div>
                                ...
                                <div class="text-center mt-4">
                                    <button type="button" class="btn btn-primary px-4" onclick="calculateTotal()">요금
                                        계산</button>
                                </div>
            ...
            <script>
                function calculateTotal() {
                    const basePrice = Number($('#basePrice').text().replace(/,/g, ''));
                ...
                function updateDisplay() {
                    ...
                    if (disGrade && weight) {
                        ...
                        $.ajax({
                            ...
                            document.getElementById("selectedRegion").innerText = res.data.regionName;
                            document.getElementById("basePrice").innerText = res.data.price.toLocaleString();
                        }).fail(function (e) {
                            swal({
                                title: "알림",
