		...
		<div class="container-fluid scroll-area">
			<div class="center-box">
				...
				<form action="/invoice/insertShopping" method="get">
					<div class="mb-3">
						<label for="disGrade" class="form-label">지역 선택</label>
						<select name="disGrade" id="disGrade" class="form-select">
					...
					<div class="mb-3">
						<label for="weight" class="form-label">무게 선택</label>
					...
					<div class="mb-3">
						<label for="adPrice" class="form-label">추가 금액</label>
						<input type="number" id="adPrice" name="adPrice" class="form-control"
