        ...
        <body>
            <nav class="side-navbar bg-sidebar-bg text-white">
                ...
                <ul class="list-unstyled">
                    <li class="sidebar-item"><a class="sidebar-link d-flex align-items-center" data-bs-toggle="collapse"
                            href="#bondAir" role="button" aria-expanded="false"> <span
                                class="material-icons me-2">fire_truck</span>
                    ...
                    <li class="sidebar-item"><a class="sidebar-link d-flex align-items-center" data-bs-toggle="collapse"
                            href="#bondSea" role="button" aria-expanded="false"> <span
                                class="material-icons me-2">receipt_long</span>
                            청구서 관리
                        </a>
                    ...
                    <li class="sidebar-item"><a class="sidebar-link d-flex align-items-center" data-bs-toggle="collapse"
                            href="#userControll" role="button" aria-expanded="false"> <span
                                class="material-icons me-2">group</span>
                                    ...
                                    <%-- 로그인을 하면 마이페이지는 보이게 하지만 3은 안보이게 설정 --%>
                                        ...
                                        <%-- 직원은 3이기 떄문에 회원 생성 못 하게 설정 --%>
                                            <c:if test="${sessionScope.user.grade != 3}">
                                                <li><a class="sidebar-link" href="/user/userJoinFrm">직원 생성</a></li>
                                            </c:if>
                                </c:if>
